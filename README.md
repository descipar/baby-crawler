...
![Tests](https://img.shields.io/badge/Tests-674%20passed-brightgreen?logo=pytest)
...
**Sprachfilter** — Fremdsprachige Anzeigen (z.B. italienische Vinted-Listings) werden anhand natürlicher Beschreibungstexte erkannt. Vinted-Beschreibungen werden aus der Detailseite nachgeladen; kurze Produkttitel werden wegen ihrer hohen Fehlerrate nie allein klassifiziert. Nur aktiv wenn `--lang` angegeben oder der Sprachfilter in den Einstellungen aktiviert ist.
